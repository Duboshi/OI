...
* 注意：
	...
	* 虽然每个阶段都推荐了多个OJ，但不需要学生做所有OJ上面的题，如何选择呢？
		...
		* 不要贪多：4-6年的信息学竞赛生涯你总共做题数量很可能在(200, 2000)区间内，不及任何一个主流OJ的题量，所以不要贪图见识太多的OJ（就如不要贪图买太多本练习册），用好1-2个贯穿学习过程的、1-2个真题备赛的、1-2个线上竞赛的即可。
...
* **从初学到省一:**  
	...
	* https://www.luogu.org/
		...
		* 洛谷主要面向国内高中信息学竞赛学生，收集了很多经典题目，还有普及组、提高组、省选、NOI等真题，把题目都按照知识点和难度标示出来了。洛谷是个很接地气的OJ，几乎每题都有其他用户写成的题解，非常适合自学。上面也包含了很多UVa、USACO、Codeforces等国际主要平台的题目，后面会讲到。
...
* **其他OJ：**
	...
	* https://vjudge.net/
		...
		* 可以抓取多个OJ的题目，适合老师用来留作业。题目没有知识点标签。如果用户选择公开代码，则代码可由其他用户查看。一些高校的ACM训练常用vjudge（例如听中山大学ACMM协会的算法讲座 - http://live.bilibili.com/6093284 他们的作业就是用这个平台布置 - https://vjudge.net/contest/199168 ）
