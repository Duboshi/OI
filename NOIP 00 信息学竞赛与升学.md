...
* 从以上信息可以看出，与升学相关的三个重要节点是：全国联赛NOIP（获得省一）:triangular_flag_on_post:、省选（进入省队）:triangular_flag_on_post:、全国决赛NOI:triangular_flag_on_post:。  
	...
	* 从上面分析我们可以看出，比较稳妥的成长路径是：
		...
		* 注意：以上这两个路径中，**省去中考复习的大半年是提升竞赛水平的关键期，不过我们不建议进一步放松对语文、数学、英语、物理等学科的学习**，信息学竞赛早规划早开始的主要目标就是给孩子一个更完整的基础教育，同时又能学有所长，而不是拆东补西，单科冒进。高一入门，高二上学期拿省一、下学期进省队、暑假全国决赛对学生天赋、师资力量都有很高要求，风险较大且影响其他学科学习，虽然偶尔就会有这样的例子出现，但信息学竞赛学习还是建议早规划、早开始。
