...
OI(Olympiad of Informatics)，国内译作`信息学竞赛`（或`信息学奥林匹克`、`程序设计竞赛`、`算法竞赛`）本文为知识大纲，大纲以知识类型相近程度归类，实际学习顺序与大纲并不完全相符。参赛过程、升学与年级学习安排具体见：《[NOIP 00 信息学竞赛与升学](/NOIP%2000%20信息学竞赛与升学.md)》
...
* **NOIP普及组**  
	...
	4. 图论：深度优先搜索，广度优先搜索，拓扑排序，欧拉回路，最小生成树
...
* **NOIP提高组**  
	...
	3. 图论：图的连通性算法，最短路，2SAT，最小生成树的优化算法，二分图的构造，二分图的匹配，网络流，启发式搜索（A* 算法与IDA* 算法）
